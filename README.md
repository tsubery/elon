...
Bitcoin has gone bad. It's wasting [immense amounts of energy](https://digiconomist.net/bitcoin-energy-consumption). It also became a cesspool of criminals and other greedy, unhetical actors. It's only fair for society to strike back at these bad actors, when appropriate.

[Elon](https://github.com/tsubery/elon) is a tool to cause the long-term outage of Bitcoin private wallets, where most of Bitcoin's value is stored. The idea behind Elon is that bad actors will think twice about using Bitcoin, if they know that organized groups of citizens can make it difficult for them to access their wallets.

Elon relies on well-known Bitcoin vulnerabilities. Security professionals [have been warning](https://www.youtube.com/watch?v=pcToFASnyrc) about those vulnerabilities for some time---but the euphoria around bitcoin has kept this information away from the spotlight. It's time to kick the golden goose in its soft, vulnerable arse.

## Overview

Bitcoin's open nature is touted as a feature, but it also makes it a sitting duck for various forms of attack. Current information about Bitcoin nodes is publicly available on https://bitnodes.io and http://bitcoinstatus.net. Most of the nodes are hosted in data centers by large companies such as Amazon, Google, and Microsoft. It would be easy to point out the hypocrisy of these companies, who are happy to provide their services in support of Bitcoin even as they flaunt their [ESG goals](https://aws.amazon.com/blogs/enterprise-strategy/it-and-esg-part-two-how-it-can-and-must-further-the-companys-esg-efforts/) and buy [carbon credits](https://www.geekwire.com/2020/amazon-pledges-10m-forest-preservation-carbon-offsets-appalachians/). Those companies could easily deal with Bitcoin like they dealt with [Parler](https://edition.cnn.com/2021/01/09/tech/parler-suspended-apple-app-store/index.html)---by kicking it off the net.

Like any distributed computer system, Bitcoin has certain features that can be exploited to make the service [unavailable](https://en.wikipedia.org/wiki/Denial-of-service_attack) to normal usage. These limitations are kept intentionally low, in order to make the software more "decentralized" for marketing purposes, making the network vulnerable to long durations of service outages outside exchanges that are likely to have privileged coordination mechanisms.
